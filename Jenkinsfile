                    ...
                    script {
                        ...
                        if (env.BRANCH_NAME != 'master') {
                            ...
                            withCredentials([
                                ...
                                sh '. venv/bin/activate && python3.8 ./go-site/scripts/directory_indexer.py -v --inject ./go-site/scripts/directory-index-template.html --directory $BUILDSTARTDATE --prefix https://kg-hub.berkeleybop.io/$S3PROJECTDIR/ -x -u'
                                ...
                                // TODO: die (above) is $S3PROJECTDIR is blank or whitespace only
                                // otherwise this will pollute the kg-hub base directory

                                // TODO: make index for project dir
                                // need a newly modified directory_indexer.py - given a bucket and a dir name, just make an index in that dir
                                // then run another s3cmd put here to upload the new index

                                // TODO: or, just make this whole chunk of indexing/uploading code its own script
